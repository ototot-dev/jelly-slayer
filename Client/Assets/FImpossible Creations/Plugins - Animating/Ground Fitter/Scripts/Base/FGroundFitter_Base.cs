...
namespace FIMSpace.GroundFitter
{
    ...
    public abstract class FGroundFitter_Base : MonoBehaviour
    {
        ...
        [System.NonSerialized] public float UpAxisRotation = 0f;
        ...
        internal virtual void RotationCalculations()
        {
            ...
            else
            {
                ...
                targetRotationToApply = Quaternion.Slerp(targetRotationToApply, targetRotation, deltaTime * Mathf.Lerp(50f, 1f, TotalSmoother));
