...
namespace Game
{
    ...
    public static class __Logger
    {
        ...
        /// <param name="reason"></param>
        /// <param name="vars"></param>
        public static void VerboseR1(GameObject context, string reason, params object[] vars) 
        {
            if (!verboseEnabled)
                return;
        ...
        /// <param name="vars"></param>
        public static void VerboseR2(GameObject context, string reason1, string reason2, params object[] vars) 
        {
            if (!verboseEnabled)
                return;
