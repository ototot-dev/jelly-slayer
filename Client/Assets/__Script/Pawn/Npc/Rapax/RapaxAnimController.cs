...
namespace Game
{
    public class RapaxAnimController : PawnAnimController
    {
        [Header("Component")]
        ...
        void Start()
        {
            ...
            __brain.onUpdate += () =>
            {
                ...
                var animMoveVecClamped = moveVecTable.OrderBy(v => Vector3.Angle(v, animMoveVec)).First();

                animMoveVec = Vector3.Lerp(animMoveVec, animMoveVecClamped, 0.5f);
