...
namespace Game
{
    [RequireComponent(typeof(HumanBotMovement))]
    [RequireComponent(typeof(HumanBotBlackboard))]
    [RequireComponent(typeof(HumanBotAnimController))]
    [RequireComponent(typeof(HumanBotActionController))]
    public class HumanBotBrain : NpcHumanoidBrain, IPawnTargetable
    {
        ...
        public HumanBotBlackboard BB { get; private set; }
        public HumanBotMovement Movement { get; private set; }
        public HumanBotAnimController AnimCtrler { get; private set; }
        public HumanBotActionController ActionCtrler { get; private set; }

        protected override void AwakeInternal()
        {
            base.AwakeInternal();

            BB = GetComponent<HumanBotBlackboard>();
            Movement = GetComponent<HumanBotMovement>();
            AnimCtrler = GetComponent<HumanBotAnimController>();
            ActionCtrler = GetComponent<HumanBotActionController>();
        }
