...
namespace Game
{
    public class NpcQuadWalkBrain : NpcBrain
    {    
        ...
        public override void ChangeDecision(int newDecision)
        {
            ...
            Debug.Assert(newDecision >= (int)NpcBrain.Decisions.None && newDecision < (int)NpcBrain.Decisions.Max);
            JellyBB.decision.currDecision.Value = (NpcBrain.Decisions)newDecision;
        }

        public NpcQuadWalkBlackboard JellyQuadWalkBB { get; private set; }
        protected float __decisionCoolTime;

        protected override void AwakeInternal()
        {
            base.AwakeInternal();
            JellyQuadWalkBB = GetComponent<NpcQuadWalkBlackboard>();
        }
