...
namespace Game
{
    [RequireComponent(typeof(Etasphera42Movement))]
    [RequireComponent(typeof(Etasphera42Blackboard))]
    [RequireComponent(typeof(Etasphera42AnimController))]
    [RequireComponent(typeof(Etasphera42ActionController))]
    public class Etasphera42Brain : JellyQuadWalkBrain
    {
        [Header("Debug")]
        ...
        public Etasphera42Blackboard BB { get; private set; }
        public Etasphera42Movement Movement { get; private set; }
        public Etasphera42AnimController AnimCtrler { get; private set; }
        public Etasphera42ActionController ActionCtrler { get; private set; }

        protected override void AwakeInternal()
        {
            base.AwakeInternal();

            BB = GetComponent<Etasphera42Blackboard>();
            Movement = GetComponent<Etasphera42Movement>();
            AnimCtrler = GetComponent<Etasphera42AnimController>();
            ActionCtrler = GetComponent<Etasphera42ActionController>();
        }
