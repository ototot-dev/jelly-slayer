...
namespace Game
{
    public class FootmanBrain : PawnBrainController, ISpawnable, IMovable
    {
        [Header("Component")]
        ...
        void ISpawnable.OnDeadHandler() { bodyAnimator.SetTrigger("OnDead"); Movement.SetMovementEnabled(false); }
