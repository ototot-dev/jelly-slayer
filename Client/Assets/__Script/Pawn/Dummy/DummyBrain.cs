...
namespace Game
{
    public class DummyBrain : PawnBrainController, ISpawnable, IMovable
    {
        [Header("Component")]
        ...
        void ISpawnable.OnDeadHandler() { animator.SetTrigger("OnDead"); Movement.SetMovementEnabled(false); }
        ...
        float IMovable.SetDestination(UnityEngine.Vector3 destination) { return Movement.SetDestination(destination); }
