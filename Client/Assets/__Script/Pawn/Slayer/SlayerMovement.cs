...
namespace Game
{
    ...
    public class SlayerMovement : PawnMovement, LegsAnimator.ILegStepReceiver
    {
        ...
        protected override void OnUpdateHandler()
        {
            ...
            if (!__brain.BB.IsHanging)
            {
                var canRotate1 = __brain.PawnBB.IsSpawnFinished && !__brain.PawnBB.IsDead && !__brain.PawnBB.IsGroggy && !__brain.AnimCtrler.CheckAnimStateTriggered("OnDown");
        ...
        protected override void OnFixedUpdateHandler()
        {
            ...
            else
            {
                if (!freezeMovement)
                {
                    var canMove1 = __brain.PawnBB.IsSpawnFinished && !__brain.PawnBB.IsDead && !__brain.PawnBB.IsGroggy && !__brain.AnimCtrler.CheckAnimStateTriggered("OnDown");
